...
original_test_annotations_dir = config_dict["env_paths"]["out_test_annotations_dir"]
...
separate_test_annotations = config_dict["settings"]["separate_test_annotations"]
...
if __name__ == "__main__":
    if 1 in scenarios_to_prepare:
        # scenario 1
        generate_scenario_1(config_dict, reader, processor, out_data_dir, replace_test_annotations, separate_test_annotations, original_test_annotations_dir)
    ...
    if 2 in scenarios_to_prepare:
        ...
        generate_scenario_234(
            ...
            separate_test_annotations=separate_test_annotations,
            original_test_annotations_dir=original_test_annotations_dir
        )
